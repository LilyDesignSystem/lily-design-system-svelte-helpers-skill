...
This repository is a Claude Skill covering the Svelte 5 *-picker helpers catalog for an AI coding agent.
...
```sh
git clone https://github.com/LilyDesignSystem/lily-design-system-svelte-helpers-skill.git
```
